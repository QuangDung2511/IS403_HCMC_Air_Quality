...
Thành phố Hồ Chí Minh là một trong những siêu đô thị phát triển nhanh nhất khu vực Đông Nam Á, kéo theo đó là sự gia tăng đột biến của các phương tiện giao thông, hoạt động công nghiệp và xây dựng. Điều này dẫn đến sự suy giảm nghiêm trọng về chất lượng không khí, đặc biệt là nồng độ bụi mịn PM2.5 vì nó có khả năng xâm nhập sâu vào hệ hô hấp và hệ tuần hoàn, gây ra các bệnh lý mãn tính. Mặc dù người dân ngày càng quan tâm đến chất lượng không khí, nhưng các hệ thống hiện tại chủ yếu chỉ cung cấp số liệu ở thời điểm hiện tại (real-time monitoring) mà thiếu đi khả năng dự báo trước để người dân có thể chủ động phòng tránh.

### 1.2. Định hướng nghiên cứu
Nghiên cứu này định hướng ứng dụng các kỹ thuật tiên tiến trong Khoa học Dữ liệu và Trí tuệ Nhân tạo (Cụ thể là Học sâu - Deep Learning) để giải quyết bài toán dự báo chuỗi thời gian đa biến (Multivariate Time-Series Forecasting). Bằng việc kết hợp nồng độ PM2.5 trong quá khứ với các yếu tố khí tượng vi mô và vĩ mô (nhiệt độ, độ ẩm, áp suất, độ cao tầng biên), nghiên cứu hướng tới việc xây dựng một hệ thống có khả năng đưa ra cảnh báo sớm về mức độ ô nhiễm trong 24 giờ tiếp theo.
...
- **Phạm vi thời gian của dữ liệu:** Dữ liệu quá khứ được giới hạn từ ngày 19/11/2024 đến thời điểm hiện tại (đảm bảo tính cập nhật và phản ánh đúng điều kiện kinh tế - xã hội bình thường mới).
