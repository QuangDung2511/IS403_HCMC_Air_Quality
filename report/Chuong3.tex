...
\end{figure}
\begin{itemize}
    \item \textbf{Nhiệt độ (Temperature):} Kết quả phân tích mật độ phân phối (\textit{density plot}) cho thấy sự khác biệt đáng kể về bản chất lý tính giữa hai nguồn dữ liệu quan trắc. Dữ liệu nhiệt độ từ hệ thống cảm biến \textit{OpenAQ} thể hiện rõ đặc tính của \textbf{vi khí hậu} (\textit{micro-climate}). Do được đo đạc trực tiếp tại các vị trí cố định trong đô thị, chuỗi số liệu này chịu tác động mạnh mẽ bởi các yếu tố nhiễu cục bộ như hiệu ứng đảo nhiệt đô thị (\textit{Urban Heat Island}), bức xạ nhiệt từ bề mặt bê tông hoặc các rào cản vật lý xung quanh trạm đo. Điều này dẫn đến một phân phối có độ nhọn cao (\textit{high kurtosis}) nhưng chứa nhiều biến động bất thường (\textit{noise}), không phản ánh đầy đủ xu thế khí tượng chung của khu vực. Ngược lại, biến số \texttt{temperature\_2m} từ \textit{Open-Meteo} đại diện cho dữ liệu \textbf{khí tượng vĩ mô} (\textit{synoptic/macro-climate}). Đây là kết quả của quá trình nội suy không gian trên các ô lưới (\textit{grid cells}) dựa trên các mô hình thời tiết toàn cầu. Việc triệt tiêu các yếu tố nhiễu vi mô giúp phân phối của \textit{Open-Meteo} bám sát các chu kỳ biến thiên nhiệt độ tự nhiên và phản ánh chính xác xu hướng thời tiết tổng thể của khu vực TP.HCM. 
...
\end{figure}
\begin{itemize}
    \item \textbf{Tốc độ và hướng gió:} Tốc độ gió tập trung chủ yếu ở dải 4--9 km/h. Tốc độ gió thấp thường dẫn đến hiện tượng đình trệ khí quyển (\textit{Stagnation}), là nguyên nhân chính gây ra các đợt tích tụ bụi mịn cục bộ. Biểu đồ hoa gió giúp xác định các hướng vận chuyển chất ô nhiễm chủ đạo từ các khu vực phát thải lân cận.
\end{itemize}
\begin{figure}[H]
    \centering
...
\end{figure}
\begin{itemize}
    \item \textbf{Độ cao tầng biên (BLH):} BLH thể hiện dữ liệu có phân bố lệch phải (right-skewed) đậm nét, với phần lớn các quan trắc tập trung ở mức thấp đến trung bình (dưới 1000m). Một tầng biên nông (thấp) sẽ nén không gian thể tích khả dụng cho việc pha trộn bụi mịn, dẫn đến nồng độ quan trắc được tăng cao ngay cả khi cường độ nguồn thải không thay đổi \cite{Tai2010}.
\end{itemize}
...
\end{figure}
\begin{itemize}
    \item \textbf{Chu kỳ giờ trong ngày (Diurnal Cycle):} Dựa trên độ phân tán dữ liệu theo giờ, chu kỳ nồng độ PM2.5 thể hiện cấu trúc phân bố một đỉnh (unimodal) thiên lệch rõ rệt vào phiên sáng. Cụ thể, pha tích tụ ô nhiễm mạnh nhất diễn ra trong phổ thời gian từ 7h00 đến 11h00. Trong đó, giá trị trung vị (đại diện cho xu hướng tập trung của dữ liệu) đạt cực đại vào thời điểm 8h00, đi kèm với các giá trị dị biệt (outliers) vọt lên mức cao nhất vào lúc 9h00. Sự gia tăng nồng độ này có thể được lý giải bằng cơ chế cộng hưởng: lượng phát thải nhân tạo tăng đột biến từ mật độ giao thông giờ cao điểm, kết hợp cùng hiện tượng nghịch nhiệt bức xạ thường xuất hiện vào đầu giờ sáng làm hạ thấp tầng biên khí quyển, qua đó ức chế quá trình khuếch tán và giam giữ chất ô nhiễm sát bề mặt. Trái ngược với pha tích tụ buổi sáng, dữ liệu từ 13h00 trở đi cho đến đêm khuya ghi nhận sự bình ổn của chất lượng không khí, với mức trung vị duy trì ở mức thấp và biên độ dao động được thu hẹp đáng kể.
    \item \textbf{Chu kỳ ngày trong tuần (Weekly Cycle):} Phân phối nồng độ PM2.5 không thể hiện sự chênh lệch rõ rệt về mức ô nhiễm nền giữa ngày làm việc (weekday) và cuối tuần (weekend). Giá trị trung vị duy trì tính ổn định cao xuyên suốt chuỗi 7 ngày. Tuy nhiên, sự khác biệt biểu hiện rõ qua độ phân tán của các giá trị dị biệt (outliers). Trong khi các ngày giữa tuần (đặc biệt là Thứ Ba) thường xuyên ghi nhận các đợt ô nhiễm bùng phát nghiêm trọng, thì cường độ của các điểm cực đoan này có xu hướng bị triệt tiêu đáng kể vào ngày Chủ Nhật.
    \item \textbf{Biến động theo tháng (Monthly Variation):} Nồng độ PM2.5 thể hiện mô hình biến thiên hình chữ U trong năm, chịu chi phối mạnh mẽ bởi yếu tố khí tượng. Giai đoạn mùa khô (đỉnh điểm là tháng 1) ghi nhận chất lượng không khí kém nhất với mức trung vị và phương sai lớn do thiếu vắng cơ chế "rửa trôi" tự nhiên. Ngược lại, mùa mưa (tháng 7, 8) đánh dấu pha bình ổn với nồng độ PM2.5 hạ xuống mức thấp nhất \cite{Seinfeld2016}.
    \end{itemize}
...
\end{figure}
\begin{itemize}
    \item \textbf{PM2.5 và Độ ẩm:} không có mối tương quan tuyến tính rõ rệt trên bình diện tổng thể, minh chứng qua đường hồi quy (trendline) gần như tiệm cận với phương ngang.
\end{itemize}
\begin{figure}[H]
    \centering
...
\end{figure}
\begin{itemize}
    \item \textbf{PM2.5 và Hướng gió:} Sự phân bố nồng độ PM2.5 theo hướng gió tại trạm đo thể hiện tính bất đẳng hướng (anisotropy) rất rõ rệt. Cụ thể, các luồng gió xuất phát từ hướng Tây (W), Tây Nam (SW), Tây Bắc (NW) và Bắc (N) thường mang theo nồng độ bụi mịn vượt trội. Sự gia tăng này có tính tương quan mạnh mẽ với vị trí địa lý của các cụm công nghiệp quy mô lớn (như KCN tại Bình Tân, Bình Chánh, và các khu vực giáp ranh Long An, Bình Dương), cũng như các trục giao thông huyết mạch có mật độ xe tải trọng lớn cao (Quốc lộ 1A, Quốc lộ 22).
\end{itemize}
